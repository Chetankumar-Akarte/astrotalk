...
class _FriendsAndFamilyState extends State<FriendsAndFamily> {
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                Text(
                  "Wallet Balance: ₹0",
                  style: TextStyle(color: Colors.blue.shade900, fontSize: 16.00, fontWeight: FontWeight.w700),
                ),
                const Spacer(),
                ElevatedButton(
                  onPressed: () {},
                  child: Text(
                    "Add Money",
                    style: TextStyle(color: Colors.blue.shade900, fontSize: 14.00, fontWeight: FontWeight.w500),
                  ),
        ...
        Padding(
          ...
          child: Row(
            ...
            children: const [
              ...
              Flexible(flex: 1, child: Text("DOB")),
              Flexible(flex: 1, child: Text("TOB")),
              Flexible(flex: 1, child: Text("Relation")),
              Spacer(),
            ],
          ),
        ),
            ...
            child: Consumer<ProfileProvider>(
              builder: (context, provider, child) {
                if (!provider.isLoading) {
                  List<Relatives> list = provider.profiles;
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              const Text(
                "Add New Profile",
                style: TextStyle(color: Colors.black54, fontSize: 16.00, fontWeight: FontWeight.w400),
              ),
            ],
          ),
        ),
  ...
  void _onEditTap(Relatives person) {
  ...
  void _onDeleteTap(Relatives person) async {
  ...
  void _onSavePressed() async {
    if (_formKey.currentState!.validate()) {
      ...
      Map? place;
      final list = await Api.getPlaceId(_placeOfBirthController.text);
      if(list.isNotEmpty) {
        place = list.first;
      }
